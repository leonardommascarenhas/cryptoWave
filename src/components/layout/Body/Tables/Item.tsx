...
const Item = ({
  ...
  return (
    <tr className="group cursor-pointer bg-white dark:bg-dark-600 hover:bg-slate-200 dark:hover:bg-dark-500 [&>*:first-child]:pl-4 [&>*:last-child]:pr-4 [&>*]:dark:border-b [&>*]:dark:border-gray-700 font-medium dark:font-normal">
