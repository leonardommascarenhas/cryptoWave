...
const MainTable = () => {
  ...
  return (
    <div className="flex justify-center items-center w-full px-3 lg:w-[95%] xl:w-[90%] mt-4  min-w-[920px] max-w-[1840px]">
      <div className=" overflow-x-auto font-poppins text-xs xl:text-sm bg-white dark:bg-dark-600 rounded-md">
